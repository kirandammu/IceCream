...
const Footer = () => {
    ...
    return (
        <div className="w-xl md:w-full px-6 md:px-16 lg:px-24 xl:px-32 bg-radial from-blue-800 to-purple-950 ">
            <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30 text-gray-300">
                <div>
                <div className='flex items-end flex-col mx-auto w-48'>
                        <div className='font-semibold text-2xl uppercase text-[orange]'>Ice <span className='text-gray-100 border-b-2 border-white'>Cream</span></div>
                </div> 
                ...
                <div className="grid grid-cols-1 md:flex justify-between w-full md:w-[45%] gap-5">
                    {footerLinks.map((section, index) => (
                        <div key={index}>
                            <h3 className="font-semibold text-base text-[orange] md:mb-5 mb-2">{section.title}</h3>
            ...
            <p className="py-4 text-center text-sm md:text-base text-amber-400">
